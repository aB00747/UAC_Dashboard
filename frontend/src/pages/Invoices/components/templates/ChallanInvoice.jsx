...
const s = StyleSheet.create({
  ...
  brandName: { fontSize: 10, fontFamily: 'Helvetica-Bold', color: BLUE, marginBottom: 2 },
  tagline: { fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#e74c3c', marginBottom: 3 },
  category: { fontSize: 7, color: BLUE, marginBottom: 1 },
  rightCompany: { flex: 1, paddingLeft: 10 },
  companyName: { fontSize: 10, fontFamily: 'Helvetica-Bold', color: BLUE },
  companyTagline: { fontSize: 7, color: '#555', marginBottom: 2 },
  companyDetail: { fontSize: 7, color: '#333', lineHeight: 1.4 },
  docTitle: { textAlign: 'center', fontFamily: 'Helvetica-Bold', fontSize: 10, color: BLUE, textDecoration: 'underline', marginVertical: 4 },
  ...
  fieldLabel: { fontFamily: 'Helvetica-Bold', width: 55, color: '#333', fontSize: 7.5 },
  fieldValue: { flex: 1, borderBottom: `0.5pt solid #aaa`, paddingBottom: 1 },
  tableHeader: { flexDirection: 'row', backgroundColor: BLUE, color: '#fff', fontFamily: 'Helvetica-Bold', fontSize: 7.5 },
  ...
  termsTitle: { fontFamily: 'Helvetica-Bold', fontSize: 7.5, marginBottom: 3, color: BLUE },
  ...
  amtWords: { marginTop: 4, fontSize: 7.5, fontFamily: 'Helvetica-Bold' },
  containerTable: { marginTop: 8, border: `1pt solid ${BLUE}` },
  containerHeader: { flexDirection: 'row', backgroundColor: BLUE, color: '#fff', fontFamily: 'Helvetica-Bold', fontSize: 7 },
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.custRow}>
          ...
          <View style={s.custRight}>
            {[['Challan No:', invoice.invoice_number], ['Dt:', invoice.invoice_date],
