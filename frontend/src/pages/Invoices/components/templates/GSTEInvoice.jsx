...
const s = StyleSheet.create({
  ...
  irnLabel: { fontFamily: 'Roboto-Bold', width: 55 },
  ...
  companyName: { fontSize: 10, fontFamily: 'Roboto-Bold' },
  ...
  metaLabel: { fontFamily: 'Roboto-Bold', width: 90, fontSize: 7.5 },
  metaValue: { flex: 1, fontSize: 7.5 },
  // Title
  titleBox: { textAlign: 'center', padding: '4 0', fontFamily: 'Roboto-Bold', fontSize: 10, borderBottom: `1pt solid #333` },
  // Buyer
  buyerBox: { padding: '4 6', borderBottom: `1pt solid #333` },
  buyerLabel: { fontFamily: 'Roboto-Bold', marginBottom: 2 },
  // Table
  tableHeader: { flexDirection: 'row', backgroundColor: '#222', color: '#fff', fontFamily: 'Roboto-Bold', fontSize: 7.5 },
  ...
  // HSN summary
  hsnHeader: { flexDirection: 'row', backgroundColor: '#555', color: '#fff', fontFamily: 'Roboto-Bold', fontSize: 7 },
  ...
  footerLabel: { fontFamily: 'Roboto-Bold', marginBottom: 1 },
  ...
  computerGenerated: { textAlign: 'center', fontSize: 7, color: '#666', marginTop: 6, fontFamily: 'Roboto-Oblique' },
});
...
export function GSTEInvoice({ invoice, profile }) {
  ...
  const pending = <Text style={{ color: '#aaa', fontFamily: 'Roboto-Oblique' }}>Pending</Text>;
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={[s.border, { marginBottom: 0 }]}>
            ...
            <View style={s.irnLeft}>
              {[['IRN', invoice.irn], ['Ack No', invoice.ack_no], ['Ack Date', invoice.ack_date]].map(([label, val]) => (
                <View key={label} style={s.irnRow}>
                  ...
                  <Text>{val || <Text style={{ color: '#bbb', fontFamily: 'Roboto-Oblique' }}>Pending</Text>}</Text>
                </View>
              ))}
            </View>
            <View style={s.qrBox}>
          ...
          <View style={s.buyerBox}>
            ...
            <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 8.5 }}>{invoice.buyer_name}</Text>
          ...
          <View style={s.totalsRow}>
            <View style={s.totalsLeft}>
              <Text style={{ fontFamily: 'Roboto-Bold', marginBottom: 2 }}>Sub Total</Text>
            </View>
            <View style={s.totalsRight}>
              ...
              <View style={s.grandLine}>
                <Text style={{ fontFamily: 'Roboto-Bold' }}>GRAND TOTAL (₹)</Text>
                <Text style={{ fontFamily: 'Roboto-Bold' }}>{fmt(grand)}</Text>
              </View>
            </View>
          </View>
          ...
          <View style={{ borderTop: `1pt solid #333`, padding: '3 6' }}>
            <Text style={{ fontFamily: 'Roboto-Bold', marginBottom: 2 }}>HSN/SAC Summary</Text>
          ...
          <View style={[s.signRow, { padding: '0 6 6 6' }]}>
            ...
            <View style={s.signBox}>
              <Text style={{ fontFamily: 'Roboto-Bold', fontSize: 7.5 }}>
